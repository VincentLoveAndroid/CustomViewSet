...
//            Element child=  _areaCodeElement.getChild("_"+areaCode);
     ...
     * @return 年龄
     */
    public int getAge(String IDCardNum){
        Calendar cal1 = Calendar.getInstance();
        Calendar today = Calendar.getInstance();
        System.out.println(IDCardNum.substring(12, 14));
        cal1.set(Integer.parseInt(IDCardNum.substring(6,10)),
                Integer.parseInt(IDCardNum.substring(10,12))-1,
                Integer.parseInt(IDCardNum.substring(12,14)));
        return getYearDiff(today, cal1);
    }
    public int getYearDiff(Calendar cal, Calendar cal1){
        int d = (cal.get(cal.DAY_OF_MONTH)) - (cal1.get(cal1.DAY_OF_MONTH));
